...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "canBeEmptyString": true,
    "help": "Specify the domain of the site.\nPlease specify the root domain. (If your site doesn\u0027t have a subdomain, you don\u0027t have to set it).\nex : If lp is `lp.example.com` and the product purchase completion page is` purchase.example.com`, specify ʻexample.com`."
  }
]
...
- name: Test function added check
  code: |-
    ...
    const exp = eagletag.cmd && eagletag.cmd.length === 2;
    assertThat(exp).isTrue();


___NOTES___

Created on 2020/10/9 18:07:47
